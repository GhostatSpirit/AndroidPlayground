...
public class FlickrFetchr {
    ...
    private static final String API_KEY = "f90a3a5a5de1d858da25494530ea09b0";
...
//    }
    ...
    public List<GalleryItem> searchPhotos(String query, Integer pageNumber){
    ...
    private String buildUrl(String method, String query, Integer pageNumber) {
        Uri.Builder uriBuilder = ENDPOINT.buildUpon()
                .appendQueryParameter("method", method)
